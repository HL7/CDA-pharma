...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:local="http://art-decor.org/functions" xmlns:hl7="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Scenario: medstat - Create Medication Statement (2.16.840.1.113883.3.1937.777.15.4.4)</title>
   ...
   <!-- Include the project schematrons related to scenario medstat -->
   <!-- UVMedicationstatement -->
   <pattern>
      <title>UVMedicationstatement</title>
      <rule context="/">
         <assert role="warning" test="descendant-or-self::hl7:substanceAdministration[hl7:templateId[@root = '2.16.840.1.113883.10.21.4.7']]" see="http://art-decor.org/art-decor/decor-templates--pharmcda-?id=2.16.840.1.113883.10.21.4.7">descendant-or-self::hl7:substanceAdministration[hl7:templateId[@root = '2.16.840.1.113883.10.21.4.7']]: Instance is expected to have the following element: %%2</assert>
      </rule>
   </pattern>
   <include href="include/2.16.840.1.113883.10.21.4.7-2023-01-30T083234.sch"/>
   <include href="include/2.16.840.1.113883.10.21.4.7-2023-01-30T083234-closed.sch"/>
   <!-- Create phases for more targeted validation on large instances -->
   <phase id="AllExceptClosed">
      <active pattern="template-2.16.840.1.113883.10.21.4.7-2023-01-30T083234"/>
   ...
   <phase id="UVMedicationstatement">
      <active pattern="template-2.16.840.1.113883.10.21.4.7-2023-01-30T083234"/>
   </phase>
   <phase id="UVMedicationstatement-closed">
      <active pattern="template-2.16.840.1.113883.10.21.4.7-2023-01-30T083234-closed"/>
   </phase>
