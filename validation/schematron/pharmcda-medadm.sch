...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:local="http://art-decor.org/functions" xmlns:hl7="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Scenario: medadm - Create Medication Administration (2.16.840.1.113883.3.1937.777.15.4.6)</title>
   ...
   <!-- Include the project schematrons related to scenario medadm -->
   <!-- UVMedicationadministration -->
   <pattern>
      <title>UVMedicationadministration</title>
      <rule context="/">
         <assert role="warning" test="descendant-or-self::hl7:substanceAdministration[hl7:templateId[@root = '2.16.840.1.113883.10.21.4.13']]" see="http://art-decor.org/art-decor/decor-templates--pharmcda-?id=2.16.840.1.113883.10.21.4.13">descendant-or-self::hl7:substanceAdministration[hl7:templateId[@root = '2.16.840.1.113883.10.21.4.13']]: Instance is expected to have the following element: %%2</assert>
      </rule>
   </pattern>
   <include href="include/2.16.840.1.113883.10.21.4.13-2023-01-30T083137.sch"/>
   <include href="include/2.16.840.1.113883.10.21.4.13-2023-01-30T083137-closed.sch"/>
   <!-- Create phases for more targeted validation on large instances -->
   <phase id="AllExceptClosed">
      <active pattern="template-2.16.840.1.113883.10.21.4.13-2023-01-30T083137"/>
      ...
      <active pattern="template-2.16.840.1.113883.10.21.4.14-2023-01-30T084254"/>
      ...
      <active pattern="template-2.16.840.1.113883.10.21.4.8-2017-03-30T000000"/>
      <active pattern="template-2.16.840.1.113883.10.21.4.9-2017-03-30T000000"/>
   </phase>
   <phase id="UVMedicationadministration">
      <active pattern="template-2.16.840.1.113883.10.21.4.13-2023-01-30T083137"/>
   </phase>
   <phase id="UVMedicationadministration-closed">
      <active pattern="template-2.16.840.1.113883.10.21.4.13-2023-01-30T083137-closed"/>
   </phase>
   ...
   <phase id="UVSubstitutionEventAdministration">
      <active pattern="template-2.16.840.1.113883.10.21.4.14-2023-01-30T084254"/>
   </phase>
   ...
   <phase id="UVMedicationOrderReference">
      <active pattern="template-2.16.840.1.113883.10.21.4.8-2017-03-30T000000"/>
   </phase>
   <phase id="UVDispenseEventReference">
      <active pattern="template-2.16.840.1.113883.10.21.4.9-2017-03-30T000000"/>
   </phase>
   ...
   <include href="include/2.16.840.1.113883.10.21.4.14-2023-01-30T084254.sch"/>
   ...
   <include href="include/2.16.840.1.113883.10.21.4.8-2017-03-30T000000.sch"/>
   <!-- UVDispenseEventReference -->
   <include href="include/2.16.840.1.113883.10.21.4.9-2017-03-30T000000.sch"/>
</schema>